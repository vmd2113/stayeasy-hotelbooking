...
import static com.duongw.stayeasy.configuration.AppConstant.*;
...
public class SearchCustomerRepository {
    ...
    public PageResponse<?> searchCustomer(int pageNo, int pageSize,  String searchKey, String sortBy){
